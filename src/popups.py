...
def popup_breakeven():
    try:
        ...
        nh = get_hashrate_from_difficulty( pin.pin[PIN_NETWORKDIFFICULTY] )
    ...
    with output.popup("Break-even analysis", size=output.PopupSize.LARGE):
        ...
        output.put_table(tdata=[[
            pin.put_input(name='be_wattage', type='number', label="Wattage"),
            pin.put_input(name='be_hashrate', type='float', label="Hashrate (terahash)"),
            pin.put_input(name='be_poolfee', type='float', label="Pool fee %", value=0)
        ]])
        ...
        output.put_table(tdata=[[
            ...
            pin.put_input(name='be_blocktxfee', type='float', label="Average block fees", value=9_000_000) # TODO - THIS IS MADNESS!!
        ]])
        ...
        output.put_table(tdata=[[
            pin.put_input(name='be_rate', type='float', label="Cost / kWh", value=0.12),
            pin.put_input(name='be_nh', type='float', label="Network hashrate (terahash)", value=nh),
        ...
        output.put_table(tdata=[[
            ...
            pin.put_input(name='res_nh', type='text', label="Network hashrate (terahash)", readonly=True),
